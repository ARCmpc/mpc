...
% %% "non-simple" inequalities hl <= h(z) <= hu
   model.nh = 5;
  model.ineq = @(z,p) [    ( (z(3)- p(12))^2 + (z(4)-p(13) )^2 - (p(14)^2));
                           ( (z(3)- p(15))^2 + (z(4)-p(16) )^2 - (p(17)^2));
                           ( (z(3)- p(18))^2 + (z(4)-p(19) )^2 - (p(20)^2));
                           ( (z(3)- p(21))^2 + (z(4)-p(22) )^2 - (p(23)^2));
                           ( (z(3)- p(24))^2 + (z(4)-p(25) )^2 - (p(26)^2));  ]; % = cos(theta) <= 1
  model.hu = +inf*ones(1,5);
  model.hl = zeros(1,5);
